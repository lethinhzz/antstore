...
<div class="row">
	...
	<div class="form-group"> 
        ...
        <div class="col-sm-10">
        	<input type="submit" name="btnLogin" style="background-color:#99C4D2;color:red" class="btn btn-primary" id="btnLogin" value="Login"/>
            <input type="submit" name="btnCancel" style="background-color:#99C4D2;color:red" class="btn btn-primary" id="btnLogin" value="Cancel"/>
		</div>  
	</div>
 </div>
