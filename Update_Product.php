...
<input type="text" name="txtShort" id="txtShort" class="form-control" placeholder="Short description" value='<?php echo $short?>'/>
				...
				<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
                              ...
                              <input type="button" style="background-color:#99C4D2;color:red" class="btn btn-primary" name="btnIgnore"  id="btnIgnore" value="Ignore" onclick="window.location='?page=product_management'" />
