...
if (isset($_GET["function"]) && $_GET["function"] == 'del') {
    if (isset($_GET["id"])) {
        ...
        $query = "SELECT COUNT(*) FROM product WHERE Cat_ID='$id'";
        ...
        if ($productCount == 0) {
            ...
            echo '<script>alert("This category has products, so you can\'t delete it.");</script>';
            echo '<meta http-equiv="refresh" content="0;URL=index.php?page=category_management"/>';
        }
    }
}
?>
        ...
        <p>
        <img src="images/add.png" alt="Add new" width="16" height="16" border="0" /> <a href="?page=add_category"  style="background-color:#99C4D2;color:red"> Add</a>
        </p>
